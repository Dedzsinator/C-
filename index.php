      ...
      <div class="col-sm-8">
        <div class="form-group">
          <form action="compile.php" id="form" name="f2" method="POST">
            <label class="lang" for="lang">Válassz nyelvet</label>
            ...
            <label for="ta">Ide írd a kódot</label>
            <textarea class="form-control" name="code" rows="10" cols="50"></textarea><br><br>
            <label for="in">Ide írd a bemeneti adatokat</label>
