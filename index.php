...
<body>
  ...
  <div>
    <div class="form-group">
      <form action="compile.php" id="form" name="f2" method="POST">
        <label style="font-size: 20px" class="lang" for="lang">Válassz nyelvet</label>
        ...
        <label style="font-size: 20px" for="ta">Ide írd a kódot</label>
        <textarea class="form-control" name="code" rows="10" cols="50"></textarea><br><br>
        <label style="font-size: 20px" for="in">Ide írd a bemeneti adatokat</label>
        <textarea class="form-control" name="input" rows="10" cols="50"></textarea><br><br>
        <input type="submit" id="st" class="btn btn-success" value="Futtatás"><br><br><br>
      ...
      <label style="font-size: 20px" for="out">Kimenet</label>
  ...
  <footer>
    <div class="footerContainer">
          ...
          <div class="social-medias flex flex-g-1">
            ...
            <a href="https://www.facebook.com/nandor.degi/" class="social-media flex">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0" x="0px"
                y="0px" fill="currentColor" width="50" height="50" class="bi bi-facebook" viewBox="0 0 50 50">
                <path
      ...
      <div style="font-size: 20px" class="copyright">A teljes project elérhető githubon <a href="https://github.com/Dedzsinator/C-">ezen a
          linken</a>. </div>
    </div>
  </footer>
